...
const HAS_VALID_GOOGLE_CONFIG = GOOGLE_CLIENT_ID && !GOOGLE_CLIENT_ID.includes("dummy");
...
export default function LoginPage() {
  ...
  const googleLogin = HAS_VALID_GOOGLE_CONFIG ? useGoogleLogin({
  ...
  function GoogleButton() {
    if (!HAS_VALID_GOOGLE_CONFIG) return null;
